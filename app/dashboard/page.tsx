...
export default async function DashboardPage({ searchParams }: DashboardPageProps) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="text-center" role="alert">
          ...
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Hiba a hónap betöltésekor</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">Sajnos nem sikerült betölteni az adatokat. Próbáld újra.</p>
          <a href="/dashboard" className="inline-flex items-center justify-center rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">
            Frissítés
          </a>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-50 focus:px-4 focus:py-2 focus:bg-blue-600 focus:text-white focus:rounded-md">
        Ugrás a fő tartalomhoz
      </a>

      {/* Navigation Bar */}
      <nav className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700" aria-label="Fő navigáció">
